...
const QuizHandler = {
  ...
  handle(handlerInput) {
    ...
    //This if statement will clearly be extremely important to us
...
const welcomeMessage = `Welcome to Matthew J Gunton's United States Quiz Game!  You can ask me about any of the fifty states and their capitals, or you can ask me to start a quiz.  What would you like to do?`;
