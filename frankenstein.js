const QuizAnswerHandler = {
  ...
  //this function is where all the real action happens
  handle(handlerInput) {
    console.log("Inside QuizAnswerHandler - handle");

    attributes seems to be where all the data is
    const attributes = handlerInput.attributesManager.getSessionAttributes();
    ...
    //the slots this skill uses are all for the answer
    //the question now is how does compare Slots work?
    //after that we can try creating our own with hello world builder there
